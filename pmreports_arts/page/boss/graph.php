                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="col">
                                ...
                                $sql = "SELECT name , department_name FROM member
                                INNER JOIN department
                                ON member.department_id = department.department_id
                                WHERE member_id = $member_id";
                                $query_member = mysqli_query($condb, $sql);
                                $result_member = mysqli_fetch_array($query_member);
                                echo "ชื่อ-สกุล : " . $result_member['name'] . "<br>";
                                echo "ตำแหน่งงาน : " . $result_member['department_name'] . "<br><br>";
                                ...
                                <div align="center">
                                    ...
                                    <div class="contain">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    <th width="20%" align="center">เดือน</th>
                                                    <th>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th>รายงานรวมทั้งหมด</th>
                                                    <th><?php echo $total_report_suc ?></th>
                                                    <th><?php echo $total_report_progress ?></th>
                                                    <th><?php echo $total_report_fail ?></th>
